    ...
    <%--가슴운동 시작--%>
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<c:url value='/user/member/exerciseType/Main_Confirm' />" name="exercise_type" method="post" id="valid_CheckForm3">
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<c:url value='/user/member/exerciseType/Main_Confirm' />" name="exercise_type" method="post" id="valid_CheckForm4">
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="image_container"> <%--이미지 바꾸기--%>
                    <img src="/resources/choi_machine/img/exercise/shoulder/S_d_p_1.jpg" class="bd-placeholder-img card-img-top" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                    <img src="/resources/choi_machine/img/exercise/shoulder/S_d_p_2.jpg" class="bd-placeholder-img card-img-top" style="display: none" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(5)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(5)">운동시작</button>
                        </div>
                    </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/shoulder' />" name="exercise_type" method="post" id="valid_CheckForm5"> <%--아이디 끝 숫자 바꾸기--%>
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(5)"> <%--파라미터 숫자 바꾸기--%>
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="image_container">
                    <img src="/resources/choi_machine/img/exercise/arm/A_d_e_1.jpg" class="bd-placeholder-img card-img-top" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                    <img src="/resources/choi_machine/img/exercise/arm/A_d_e_2.jpg" class="bd-placeholder-img card-img-top" style="display: none" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(6)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(6)">운동시작</button>
                        </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/shoulder' />" name="exercise_type" method="post" id="valid_CheckForm6">
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(6)">
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="image_container"> <%--이미지 바꾸기--%>
                    <img src="/resources/choi_machine/img/exercise/shoulder/S_d_s_1.jpg" class="bd-placeholder-img card-img-top" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                    <img src="/resources/choi_machine/img/exercise/shoulder/S_d_s_2.jpg" class="bd-placeholder-img card-img-top" style="display: none" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(7)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(7)">운동시작</button>
                        </div>
                    </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/shoulder' />" name="exercise_type" method="post" id="valid_CheckForm7">
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(7)">
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="image_container"> <%--이미지 바꾸기--%>
                    <img src="/resources/choi_machine/img/exercise/shoulder/S_s_b_r_1.jpg" class="bd-placeholder-img card-img-top" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                    <img src="/resources/choi_machine/img/exercise/shoulder/S_s_b_r_2.jpg" class="bd-placeholder-img card-img-top" style="display: none" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(8)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(8)">운동시작</button>
                        </div>
                    </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/shoulder' />" name="exercise_type" method="post" id="valid_CheckForm8">
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(8)">
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="image_container">
                    <img src="/resources/choi_machine/img/exercise/shoulder/S_p_p_1.jpg" class="bd-placeholder-img card-img-top" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                    <img src="/resources/choi_machine/img/exercise/shoulder/S_p_p_2.jpg" class="bd-placeholder-img card-img-top" style="display: none" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(9)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(9)">운동시작</button>
                        </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/shoulder' />" name="exercise_type" method="post" id="valid_CheckForm9">
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(9)">
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(10)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(10)">운동시작</button>
                        </div>
                    </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/core' />" name="exercise_type" method="post" id="valid_CheckForm10"> <%--아이디 끝 숫자 바꾸기--%>
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(10)"> <%--파라미터 숫자 바꾸기--%>
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(11)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(11)">운동시작</button>
                        </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/core' />" name="exercise_type" method="post" id="valid_CheckForm11">
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(11)">
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(12)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(12)">운동시작</button>
                        </div>
                    </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/core' />" name="exercise_type" method="post" id="valid_CheckForm12">
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(12)">
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(13)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(13)">운동시작</button>
                        </div>
                    </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/core' />" name="exercise_type" method="post" id="valid_CheckForm13">
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(13)">
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(14)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(14)">운동시작</button>
                        </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/core' />" name="exercise_type" method="post" id="valid_CheckForm14">
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(14)">
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="image_container"> <%--이미지 바꾸기--%>
                    <img src="/resources/choi_machine/img/exercise/arm/A_d_c_1.jpg" class="bd-placeholder-img card-img-top" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                    <img src="/resources/choi_machine/img/exercise/arm/A_d_c_2.jpg" class="bd-placeholder-img card-img-top" style="display: none" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(15)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(15)">운동시작</button>
                        </div>
                    </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/arm' />" name="exercise_type" method="post" id="valid_CheckForm15"> <%--아이디 끝 숫자 바꾸기--%>
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(15)"> <%--파라미터 숫자 바꾸기--%>
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(16)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(16)">운동시작</button>
                        </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/arm' />" name="exercise_type" method="post" id="valid_CheckForm16">
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(16)">
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="image_container"> <%--이미지 바꾸기--%>
                    <img src="/resources/choi_machine/img/exercise/arm/A_d_k_1.jpg" class="bd-placeholder-img card-img-top" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                    <img src="/resources/choi_machine/img/exercise/arm/A_d_k_2.jpg" class="bd-placeholder-img card-img-top" style="display: none" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(17)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(17)">운동시작</button>
                        </div>
                    </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/arm' />" name="exercise_type" method="post" id="valid_CheckForm17">
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(17)">
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="image_container"> <%--이미지 바꾸기--%>
                    <img src="/resources/choi_machine/img/exercise/arm/A_s_p_1.jpg" class="bd-placeholder-img card-img-top" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                    <img src="/resources/choi_machine/img/exercise/arm/A_s_p_2.jpg" class="bd-placeholder-img card-img-top" style="display: none" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(18)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(18)">운동시작</button>
                        </div>
                    </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/arm' />" name="exercise_type" method="post" id="valid_CheckForm18">
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <div class="input-group input-group-sm mb-3">
                                <span class="input-group-text">운동 명</span> <%--운동명 value 바꾸기--%>
                                <input type="text" name="exer_name" class="form-control" value="사이드 푸쉬업" readonly="readonly" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm2">
                            </div>
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(18)">
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="image_container">
                    <img src="/resources/choi_machine/img/exercise/arm/A_d_r_1.jpg" class="bd-placeholder-img card-img-top" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                    <img src="/resources/choi_machine/img/exercise/arm/A_d_r_2.jpg" class="bd-placeholder-img card-img-top" style="display: none" width="100%" height="300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(19)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(19)">운동시작</button>
                        </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/arm' />" name="exercise_type" method="post" id="valid_CheckForm19">
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(19)">
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <span class="badge rounded-pill bg-primary w-auto">대퇴사두근/햄스트링</span> <%--발달부위 바꾸기--%>
                    <hr>
                    <span class="badge rounded-pill bg-warning text-dark mb-2">TIP !</span> <%--팁 바꾸기--%>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(20)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(20)">운동시작</button>
                        </div>
                    </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/low' />" name="exercise_type" method="post" id="valid_CheckForm20"> <%--아이디 끝 숫자 바꾸기--%>
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <div class="input-group input-group-sm mb-3">
                                <span class="input-group-text">운동 명</span> <%--운동명 value 바꾸기--%>
                                <input type="text" name="exer_name" class="form-control" value="덤벨 리어런지" readonly="readonly" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm2">
                            </div>
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(20)"> <%--파라미터 숫자 바꾸기--%>
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <span class="badge rounded-pill bg-primary w-auto">대퇴사두근/둔근</span>
                    <hr>
                    <span class="badge rounded-pill bg-warning text-dark mb-2">TIP !</span>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(21)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(21)">운동시작</button>
                        </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/low' />" name="exercise_type" method="post" id="valid_CheckForm21">
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <div class="input-group input-group-sm mb-3">
                                <span class="input-group-text">운동 명</span>
                                <input type="text" name="exer_name" class="form-control" value="덤벨 스쿼트" readonly="readonly" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm2">
                            </div>
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(21)">
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <span class="badge rounded-pill bg-primary w-auto">대퇴사두근</span> <%--발달부위 바꾸기--%>
                    <hr>
                    <span class="badge rounded-pill bg-warning text-dark mb-2">TIP !</span> <%--팁 바꾸기--%>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(22)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(22)">운동시작</button>
                        </div>
                    </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/low' />" name="exercise_type" method="post" id="valid_CheckForm22">
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <div class="input-group input-group-sm mb-3">
                                <span class="input-group-text">운동 명</span> <%--운동명 value 바꾸기--%>
                                <input type="text" name="exer_name" class="form-control" value="덤벨 스플릿 스쿼트" readonly="readonly" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm2">
                            </div>
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(22)">
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <span class="badge rounded-pill bg-primary w-auto">발목/햄스트링</span> <%--발달부위 바꾸기--%>
                    <hr>
                    <span class="badge rounded-pill bg-warning text-dark mb-2">TIP !</span> <%--팁 바꾸기--%>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(23)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(23)">운동시작</button>
                        </div>
                    </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/low' />" name="exercise_type" method="post" id="valid_CheckForm23">
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(23)">
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <span class="badge rounded-pill bg-primary w-auto">대퇴사두근/햄스트링</span>
                    <hr>
                    <span class="badge rounded-pill bg-warning text-dark mb-2">TIP !</span>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <button type="button" class="move_img btn btn-sm btn-outline-secondary" onclick="javascript:exer_How(24)">운동보기</button>
                        </div>

                        <small class="text-muted">9 mins</small>

                        <div class="btn-group">
                            <button type="button" class="start_exer btn btn-sm btn-outline-secondary" onclick="javascript:exer_Start(24)">운동시작</button>
                        </div>
                    ...
                    <form action="<c:url value='/user/member/exerciseType/low' />" name="exercise_type" method="post" id="valid_CheckForm24">
                        ...
                        <div class="hidden_exer mt-3">
                            ...
                            <div class="input-group input-group-sm mb-3">
                                <span class="input-group-text">운동 명</span>
                                <input type="text" name="exer_name" class="form-control" value="덤벨 스텝업" readonly="readonly" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm2">
                            </div>
                            ...
                            <input type="button" class="btn btn-sm btn-outline-secondary" value="완료" onclick="valid_Check(24)">
