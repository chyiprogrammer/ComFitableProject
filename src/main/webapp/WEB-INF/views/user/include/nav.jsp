		...
		<div class="container-fluid">
			...
			<div class="navbar-collapse justify-content-md-center" id="navbarsExample10">
				<ul class="navbar-nav">
					...
					<li class="nav-item text-center"><a href="<c:url value='/user/member/exerciseType/Main' />" class="nav-link">운동 목록</a></li>
					...
					<c:if test="${list eq 1}">
						<li class="nav-item dropdown text-center" id="list_name">
							...
							<ul class="dropdown-menu text-center" aria-labelledby="dropdown10">
								<li><a class="dropdown-item chest" href="<c:url value='/user/member/exerciseType/chest_yet' />">가슴</a></li>
								<li><a class="dropdown-item shoulder" href="<c:url value='/user/member/exerciseType/shoulder_yet' />">어깨</a></li>
								<li><a class="dropdown-item back" href="<c:url value='/user/member/exerciseType/core_yet' />">코어</a></li>
								<li><a class="dropdown-item arm" href="<c:url value='/user/member/exerciseType/arm_yet' />">팔</a></li>
								<li><a class="dropdown-item low" href="<c:url value='/user/member/exerciseType/low_yet' />">하체</a></li>
							</ul>
