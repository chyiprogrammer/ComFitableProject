...
public class AdminMemberVO {
    ...
    int a_m_no, a_m_approval;

    String a_m_id, a_m_pw, a_m_name, a_m_gender, a_m_part, a_m_position, a_m_mail, a_m_phone, a_m_reg_date, a_m_mod_date;

    public AdminMemberVO(){

    }
    public AdminMemberVO(int a_m_no, int a_m_approval, String a_m_id, String a_m_pw, String a_m_name, String a_m_gender, String a_m_part, String a_m_position, String a_m_mail, String a_m_phone, String a_m_reg_date, String a_m_mod_date) {
        this.a_m_no = a_m_no;
