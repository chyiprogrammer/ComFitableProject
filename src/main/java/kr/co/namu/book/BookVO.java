...
public class BookVO {
    ...
    int b_no, b_rental_able;
    String b_thumbnail, b_name, b_author, b_publisher, b_publish_year, b_isbn, b_call_number,b_reg_date,b_mod_date;

    public BookVO() {
    }

    public BookVO(int b_no, int b_rental_able, String b_thumbnail, String b_name, String b_author, String b_publisher, String b_publish_year, String b_isbn, String b_call_number, String b_reg_date, String b_mod_date) {
        this.b_no = b_no;
